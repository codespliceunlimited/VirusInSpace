...
setupItem(Loot.pistol,		"Hand Gun", c, objWeapon,sprPistol,	8,		"Pistol Packen Papa",	1, 0.5);
setupItem(Loot.autoRifle,	"Ar-15",	c, objWeapon,sprRifle,	20,		"Is this thing legal?",	3, 1);
setupItem(Loot.shotgun,		"Shotgun",	c, objWeapon,sprShotgun,12,		"2 words, Cha Chink",	5, 0.8);
setupItem(Loot.boltAction,	"Rifle",	c, objWeapon,sprRifle,	10,		"Am I a sniper now?",	1, 1.5);
